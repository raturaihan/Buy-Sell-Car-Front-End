    ...
    <div>
      ...
      <div className="container mt-5">
        ...
        <div className="row mt-5">
          ...
          <div className="col mt-5">
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid eius suscipit aperiam rem dolores nemo, incidunt quos optio repellendus, fugiat debitis doloribus. Laboriosam aliquid, est officiis deserunt incidunt provident rem?</p>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis asperiores deserunt, dolorem molestias impedit, voluptate iste nihil vitae nostrum.</p>
            <p>
              <strong>
                SEA Digital Talent
                <br />
