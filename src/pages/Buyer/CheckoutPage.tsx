...
function CheckoutPage() {
  ...
  const perMonthAmount = () => {
    let perMonth = finalAmount() / (parseInt(calculator.year)*12)
              ...
              {isInstallment ? (
                <>
                  ...
                  <div className="row mt-4">
                    ...
                    <p className="text-center fw-bold">{calculator.year} Years</p>
                    <div className="d-flex justify-content-center">
                      <input
                        ...
                        max="5"
                        step="1"
                        onChange={(e) => setCalculator({year: e.target.value, dp: calculator.dp})}
                      />
                    </div>
                  </div>
